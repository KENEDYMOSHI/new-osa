...
<head>
    ...
    <title>Provisional Outurn Report</title>
    <style>
    * {
        margin: 0;
        padding: 0;
...
?>
    ...
    <div class="wrapper">
        ...
        <h3>PROVISIONAL OUTURN REPORT</h3>
    </div>
    <!--  -->
        ...
        <table class="table" border="1">
            <thead class="">
                ...
                <tr>
                    ...
                    <th colspan="2">DIFFERENCE</th>
                    <th colspan="3" rowspan="2">BL FIGURE</th>
                </tr>
                <tr>
...
$blMetricTons += $data->bl_metric_tons;
$blMetricTonsDifference += $data->bl_metric_tons_difference;
$blMetricTonsPercentage += $data->bl_metric_tons_percentage;
...
?>
                <tr>
                    ...
                    <td><?=$data->bl_metric_tons?></td>
                    <td><?=$data->bl_metric_tons_difference?></td>
                    <td><?=$data->bl_metric_tons_percentage . ' %'?></td>
                ...
                <tr>
                    ...
                    <!-- round(($blMetricTonsDifference / $blMetricTons) * 100, 2) -->
                </tr>
