...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <h5 class="text-center" ><b id="title">INSTRUMENT ANALYSIS REPORT OF FINANCIAL YEAR <?= $financialYear ?></b></h5>
            ...
            <div class="card-footer">
                <a href="<?= base_url("downloadAdjustedInstruments/$date1/$date2/$month/$year/$title") ?>" id="link" target="_blank" class="btn btn-primary btn-sm "><i class="fal fa-download    "> </i> Download</a>
            </div>
        </div>
    ...
    <script>
        ...
        instrumentForm.addEventListener('submit', e => {
            ...
            if ($('#instrumentForm').valid()) {
                ...
                fetch('filterAdjustedInstruments', {
                        method: 'POST',
                        headers: {
