                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control " name="lorryCapacity" placeholder="Enter  lorry Capacity in Cubic Meter" required>
                        ...
                        <div class="modal-body">
                            <div id="lorryInfo">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="must">Lorry Capacity in m<sup>3</sup></label>
                                        <input type="number" class="form-control " id="lorryCapacity" name="lorryCapacity" placeholder="Enter  lorry Capacity in Cubic Meter" required>

                                    </div>
                                    <div class="form-group col-md-6" id="sticker" style="display: none;">
                                        <label>Sticker Number</label>
                                        <input type="text" class="form-control sblSticker " id="stickerNumber" name="stickerNumber" placeholder="Enter Sticker Number" required>
...
<script>
        ...
        <div class="row p-2 elevation-0 mb-2" style="border:1px solid #e7e5e5; border-radius:4px">
           ...
           <div class="col-md-4">
               <div class="form-group">
                   ...
                   <input type="text" name="trailerPlate[]" id="" class="form-control" placeholder="Trailer Plate Number" oninput="this.value = this.value.toUpperCase().replaceAll(/\s/g,'')">
               </div>
           </div>
           <div class="col-md-4">
               <div class="form-group">
                   <label for="">Trailer Plate Capacity</label>
                   <input type="number" name="trailerCapacity[]" id="" class="form-control" placeholder="Trailer Plate Capacity">

               </div>
           </div>
           <div class="col-md-4">
               <div class="form-group">
                   <label for="">Trailer Sticker Number</label>
                   <input type="text" name="trailerSticker[]" id="" class="form-control sblSticker" placeholder="Trailer  Sticker Number">
    ...
    updateLorryForm.addEventListener('submit', e => {
        e.preventDefault()
        if ($('#updateLorryForm').valid()) {

            submitInProgress(e.submitter)
            const formData = new FormData(updateLorryForm)
            fetch("updateLorry", {
                    method: "POST",
                    headers: {
                        "X-Requested-With": "XMLHttpRequest",
