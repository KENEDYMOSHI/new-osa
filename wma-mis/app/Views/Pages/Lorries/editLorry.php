...
<section class="content body">
    <div class="container-fluid">
        ...
        <?= form_open_multipart(base_url('lorries/updateLorry/' . $record->id)) ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="far fa-cogs icon"></i>Lorries Technical Details</h3>
                        <div class="card-tools">
                            <!-- Buttons, labels, and many other things can be placed here! -->
                            <!-- Here is a label for example -->
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?= $this->include('Components/Lorries/lorryTechnicalDetailsEdit'); ?>
                    </div>
                    <!-- /.card-body -->
