        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Reports</a></li>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <h5 class="text-center"><b id="title">INSTRUMENT ANALYSIS REPORT OF <?= $reportTitle ?></b></h5>
            ...
            $month = date('m');
            $year = date('Y');
            $title = 'INSTRUMENTS INSPECTION REPORT OF ' . $reportTitle;
            ?>
            <div class="card-footer">
                <a href="<?= base_url("downloadStampedInstruments/$month/$year/$title") ?>" id="link" target="_blank" class="btn btn-primary btn-sm "><i class="fal fa-download    "> </i> Download</a>
            </div>
        </div>
                    ...
                    .then(data => {
                        ...
                        if (status == 1) {
                            ...
                            $(document).ready(function() {
                                $('.table').DataTable({
                                    dom: 'Bfrtip', // Only show the buttons
                                    buttons: [
                                        'excelHtml5' // Excel export button
                                    ],
                                    searching: false, // Disable search
                                    paging: false, // Disable pagination
                                    info: false // Disable table info (e.g., "Showing 1 of 10 entries")
                                });
                            });
                        }
