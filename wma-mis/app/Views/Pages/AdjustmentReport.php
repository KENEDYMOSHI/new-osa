    ...
    <div class="container-fluid">
        ...
        <div class="card">
                ...
                <form id="instrumentForm">
                    <div class="row">
                        ...
                        <div class="col-md-3 ">
                            ...
                            <input type="text" hidden name="status" class="form-control" value="<?=url_is('rejected') ? 'Rejected' : 'Condemned'?>">
            ...
            <pre>
                <!-- <?php
                        print_r($instruments);
                        $status = url_is('rejected') ? 'Rejected' : 'Condemned';
                        $title = $status . " INSTRUMENTS INSPECTION REPORT OF FINANCIAL YEAR " . $financialYear;
                        ?> -->
            </pre>
            <p class="text-center"><?= '' ?></p>
            <h5 class="text-center"><b id="title"><?= strtoupper($title) ?> </b></h5>
            ...
            <div class="card-footer">
                <a href="<?= base_url("downloadInspected/$date1/$date2/$month/$year/$title/$status") ?>" id="link" target="_blank" class="btn btn-primary btn-sm "><i class="fal fa-download    "> </i> Download</a>
            </div>
        </div>
