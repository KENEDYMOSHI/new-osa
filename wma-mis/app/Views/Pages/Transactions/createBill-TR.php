        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-3">
                        <div class="form-group">
                            <label class="must" for="">Bill Type</label>
                            <select class="form-control" name="billType" id="billType" required>
                                <option value="">-- Select BillType --</option>
                                <option value="1">Normal Bill</option>
                                <option selected value="2">Combined Bill</option>
                            </select>
                        </div>
                    </div> -->
                    <div class="col-md-3">
            ...
            <div class="card-body1">
                ...
                <div class="card" id="source">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-md-3 stretch">
                            <div class="form-group">
                                ...
                                <select class="form-control billItemName select2bs4" name="GfsCode[]" id="" style="width:100%" onchange="toggleFields(this,'001')">
                                    ...
                                    <?php $except = ['142101210003', '142101210013', '142101210035', '142101210007', '142201611278'] ?>
                                    ...
                                    <?php if ($user->inGroup('accountant','accountant-hq','superadmin')): ?>
                                        <option value="142201611278">Miscellaneous Receipt </option>
                        ...
                        <div class="col-md-12" id="imported001" style="display:none">
                            <div class="row">
                                <div class="col-md-4 form-group">
...
<script>
    ...
    function handleTaskChange(selectElement) {
        ...
        for (let i = 0; i < omitDivs.length; i++) {
            omitDivs[i].style.display = (selectElement.value === 'Consultation' || selectElement.value === 'Other') ? 'none' : 'block';
            omitDivs[i].style.display = (selectElement.value === 'Consultation' || selectElement.value === 'Other') ? 'none' : 'block';
            if (selectElement.value === 'Consultation' || selectElement.value === 'Other') omitDivs[i].querySelector('.form-control').value = ''
            // omitDivs[i].querySelector('.form_control').value = (selectElement.value === 'Consultation' || selectElement.value === 'Other') ? '' :  omitDivs[i].value ;
        }

        // Get the parent div with class 'billFigures' within the grandparent
        let billFiguresDiv = grandparent.querySelector('.billFigures');

        // Change class based on the selected value
        if (selectElement.value === 'Consultation' || selectElement.value === 'Other') {
            billFiguresDiv.classList.remove('col-md-6');
            billFiguresDiv.classList.add('col-md-12');
        } else {
            // Reverse back if the value is not 'Consultation'
            billFiguresDiv.classList.remove('col-md-12');
            billFiguresDiv.classList.add('col-md-6');
        }

        // Find all divs with class 'stretch' within the grandparent
        let stretchDivs = grandparent.querySelectorAll('.stretch');

        // Adjust column width based on the selected value
        for (let i = 0; i < stretchDivs.length; i++) {
            if (selectElement.value === 'Consultation' || selectElement.value === 'Other') {
                stretchDivs[i].classList.remove('col-md-3');
                stretchDivs[i].classList.add('col-md-6');
            } else {
                // Reverse back if the value is not 'Consultation'
                stretchDivs[i].classList.remove('col-md-6');
                stretchDivs[i].classList.add('col-md-3');
            }
        }
    }
    ...
    function addRevenueSource() {
        ...
        <div class="card">
                    ...
                    <div class="col-md-3 stretch">
                        ...
                        <div class="col-md-12" id="imported${randomNumber}" style="display:none">
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label for="">F.O.B</label>
                                    <input type="text" name="fob[]" id="fob" pattern="[0-9]*" class="form-control" placeholder="" required oninput="formatDigits(this)" >
    ...
    billSubmissionRequest.addEventListener('submit', (e) => {
        ...
        if ($('#billSubmissionRequest').valid()) {
            ...
            fetch('combinedBillSubmissionRequest', {
                    method: 'POST',
                    headers: {
