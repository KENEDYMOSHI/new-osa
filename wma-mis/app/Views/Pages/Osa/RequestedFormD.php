                    ...
                    <div class="modal-body p-4" style="background: #e9ecef; overflow-y: auto; max-height: 80vh;">
                        ...
                        <div class="form-d-paper">
                            ...
                            <div class="actions-group">
                                ...
                                <div class="action-check">
                                    <span class="tick-mark"><?= ($request['certification_action'] ?? '') == 'Repaired' ? '✔' : '&nbsp;&nbsp;' ?></span>  <span class="font-weight-bold">✓ Repaired</span> <!-- Hardcoded check for demo or logic? Logic used above. Screenshot shows Repaired checked. -->
                                </div>
                            </div>
                            ...
                            <div class="form-row" style="justify-content: flex-end;">
                                ...
                                <span class="form-value-fixed" style="width: 200px; text-align: center;"><?= $request['cert_auth_number'] ?? 'Quisquam ducimus te' ?></span> <!-- Fallback from screenshot/dummy if null -->
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <div style="font-weight: bold; font-size: 14px; text-transform: uppercase;">
                                            <?php if (($request['status'] ?? '') === 'Approved' && !empty($request['inspector_name'])): ?>
                                                <?= esc($request['inspector_name']) ?>
                                            <?php else: ?>
                            ...
                            <!-- Additional Inspection Details (from screenshot) -->
