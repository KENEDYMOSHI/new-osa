...
<style>
    ...
    .cv-container table tr:hover { background: #fafafa; }
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <!-- <h1 class="m-0 text-dark">Application Profile</h1> -->
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>/viewCompleteApplication">Approved Applications</a></li>
...
<div class="container-fluid">
    <div class="cv-container">
        ...
        <div class="action-bar">
            <a href="<?= base_url('viewCompleteApplication') ?>" class="back-link">
        ...
        <div class="cv-header">
            ...
            <div class="header-info">
                ...
                <!-- Control Number removed as per request -->
                <div class="header-info-item">
