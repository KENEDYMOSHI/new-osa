                            ...
                            <table id="example1" class="table table-bordered ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="head">Tank Capacity</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($bulkStorageTankResults as $bst) : ?>
                                    <tr>
                                        <td><?= $bst->first_name . '  ' . $bst->last_name ?></td>
                                        <td><?= $bst->gender ?></td>
                                        <td><?= $bst->region ?></td>
                                        <td><?= $bst->ward ?></td>
                                        <td><?= $bst->postal_address ?></td>
                                        <td><?= $bst->phone_number ?></td>
                                        <td><?= dateFormatter($bst->date) ?></td>
                                        <td><?= $bst->next_calibration ?></td>
                                        <td><?= $bst->filling_station ?></td>
                                        <td><?= $bst->number_of_tanks ?></td>
                                        <td><?= $bst->capacity ?>Litters</td>
                                        <td><?= $bst->product ?></td>
                                        <td><?= $bst->remark ?></td>


                                        <td>
                                            <?php if ($bst->status == 'Valid') : ?>
                                        ...
                                        <?php if ($role == 1 || $role == 2) : ?>
                                        <td>
                                            <a href="<?= base_url() ?>/editBulkStorageTank/<?= $bst->id ?>"
                                                class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                                            <a href="<?= base_url() ?>/deleteBulkStorageTank/<?= $bst->id ?>"
