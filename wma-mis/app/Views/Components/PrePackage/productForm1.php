                        ...
                        <div class="card-body">
                            <div id="technical">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="categoryAnalysis" id="categoryAnalysis" onchange="javascript: if(this.value =='Linear 2' || this.value =='Area & Linear' || this.value =='Area_Linear') {$('#otherQuantity').show(); $('#gaugeBlock').show()} else {$('#otherQuantity').hide();$('#gaugeBlock').hide()}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Declared Size/Quantity/Dimention/Measures</label>
                                            <input type="number" name="quantity" id="quantity" class="form-control" placeholder="Size/Quantity/Dimention/Measures" min="0" required>
