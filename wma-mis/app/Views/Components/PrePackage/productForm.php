                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Size/Quantity/Dimension/Measures" min="0" required 
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); getGrosQuantity(this.value)" readonly>
...
`
            ...
            function calcGross(unit) {
                const qty = document.querySelector('#quantity').value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');
