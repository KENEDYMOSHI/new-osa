<!-- Modal -->
<div class="modal fade" id="mapModal"  role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
...
<div class="clientsBlock">
    <div class="modal fade" id="addModal"  role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="searchModal"  role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<!-- AIzaSyCC-lh4u5vuBOJmiaFrVJu8n-xqovjS-58 -->
<script>
